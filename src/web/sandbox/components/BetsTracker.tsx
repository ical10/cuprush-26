        ...
        {(["progress", "won", "lost"] as const).map((tab) => {
          ...
          return (
            <button
              ...
              className={`py-2! px-1! text-center! font-display! text-xs! uppercase! tracking-wider! clip-control transition-all! transform! active:scale-95! cursor-pointer! ${
                isActive
                  ? "bg-accent! text-bg! font-extrabold!"
                  : "text-text-dim! font-black! hover:text-text-main! hover:bg-surface-raised/55!"
              }`}
            >
